...
<#include "header.ftl">
    ...
    <div style="text-align: center">
        <a href="/worker/todo" class="btn btn-theme">Заявки</a>
    </div>
<#if done?? && done?has_content>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <table>
                        ...
                        <#list done as done_one>
                            <tr>
                                <td style="padding: 5px">${done_one.firstName}</td>
                                <td style="padding: 5px">${done_one.lastName}</td>
                                <td style="padding: 5px">${done_one.phoneNumber}</td>
                                <td style="padding: 5px">${done_one.address}</td>
                            </tr>
                        </#list>
                    </table>
                </div>
